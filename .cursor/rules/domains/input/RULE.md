...
- DOM vs Canvas interaction modes
- Picking and intent events
- Inertia and momentum

## Rules
- Normalize mouse/touch/pen; use pointer capture for drags
- Emit intent events; never navigate directly
...
- [ ] Pointer capture used for drags
- [ ] Intents emitted; no direct nav
- [ ] Keyboard equivalents present
- [ ] Picking hits expected targets
