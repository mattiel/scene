...
6. **Progressive enhancement** - Library evolves through real implementations. When demos reveal gaps, enhance primitives—don't work around them. See `@enhancement` rule.
...
| Demo/implementation work | `@enhancement` |
